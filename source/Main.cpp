...
int main(int argc, char** argv) {
	...
	cpu.setMemory8 (0x0,    0x1); //Set register 0 to 5 (Instruction 0x1)
	cpu.setMemory8 (0x1,    0x0); //Set argument 1: register 0 (target register)
	cpu.setMemory8 (0x2,    0x5); //Set argument 2: value of 5
	cpu.setMemory8 (0x4,    0x1); //Set register 1 to 9 (Instruction 0x1)
	cpu.setMemory8 (0x5,    0x1); //Set argument 1: register 1 (target register)
	cpu.setMemory8 (0x6,    0x9); //Set argument 2: value of 9
	cpu.setMemory8 (0x8,    0x6); //Sum register 0 and register 1 (Instruction 0x6)
	cpu.setMemory8 (0x9,    0x0); //Set argument 1: register 0 (target register)
	cpu.setMemory8 (0xA,    0x0); //Set argument 2: register 0 (first register to sum)
	cpu.setMemory8 (0xB,    0x1); //Set argument 3: register 1 (second register to sum)
	cpu.setMemory8 (0xC,   0x22); //Print int to console (Instruction 0x22)
	...
	*/
	...
	cpu.setMemory8 (0x0,   0x23); //Store console input (Instruction 0x23)
	cpu.setMemory16(0x1,  0x100); //Set argument 1: memory address 0x100 (target memory address)
	cpu.setMemory8 (0x3,    0x2); //Read 1 byte from meory (Instruction 0x2)
	cpu.setMemory8 (0x4,    0x0); //Set argument 1: register 0 (target register)
	cpu.setMemory16(0x5,  0x100); //Set argument 2: memory address 0x100 (target memory address)
	cpu.setMemory8 (0x7,   0x22); //Print character to screen (Instruction 0x22)
	cpu.setMemory16(0x8, 0xFFF0); //Set argument 1: register 0 (target register in 0xFFF0..0xFFF7 format)
	*/
	...
	cpu.setMemory8 (0x6 ,   0x1F); //Call the function (instruction 0x1E)
	cpu.setMemory8 (0x7 ,      0); //Set argument 1: register 0
	cpu.setMemory16(0x8 ,    0xE); //Set argument 2: function memory location
	cpu.setMemory8 (0xA ,   0x21); //Print int (Instruction 0x20)
	cpu.setMemory16(0xB , 0xFFF0); //Set argument 1: register 0
	cpu.setMemory8 (0xD ,      0); //Nothing
	cpu.setMemory8 (0xE ,   0x1E); //Pop top of stack and store (Instruction 0x1D)
	cpu.setMemory8 (0xF ,      1); //Set argument 1: register 1
	cpu.setMemory8 (0x10,   0x1E); //Pop top of stack and store (Instruction 0x1D)
	...
	cpu.setMemory8 (0x16,   0x20); //Return (Instruction 0x20)
	...
	*/
	...
	cpu.setMemory8 (0x3 ,   0x1F); //Call the function (Instruction 0x1F)
	...
	cpu.setMemory8 (0x7 ,   0x21); //Print int (Instruction 0x21)
	cpu.setMemory16(0x8 , 0xFFF0); //Set argument 1: register 0 (register in 0xFFF0.0xFFF7 format)
	cpu.setMemory8 (0xA ,      0); //Nothing
	cpu.setMemory8 (0xB ,   0x1E); //Pop top of stack and store (Instruction 0x1E)
	...
	cpu.setMemory8 (0x11,   0x16); //Check if register 1 holds greater value than register 2 (Instruction 0x16) (Unsigned)
	...
	cpu.setMemory8 (0x15,   0x18); //Check if the value in register 3 is 0 (Instruction 0x18)
	...
	cpu.setMemory8 (0x1D,    0xC); //Decrement register 2 (Instruction 0xC)
	cpu.setMemory8 (0x1E,    0x2); //Set argument 1: register 2
	cpu.setMemory8 (0x1F,   0x1D); //Push value of register 1 to stack (Instruction 0x1D)
	cpu.setMemory16(0x20, 0xFFF1); //Set argument 1: register 1 (register in 0xFFF0.0xFFF7 format)
	cpu.setMemory8 (0x22,   0x1C); //Push value of register 2 to temp stack (Instruction 0x1C)
	cpu.setMemory16(0x23, 0xFFF2); //Set argument 1: register 2 (register in 0xFFF0.0xFFF7 format)
	cpu.setMemory8 (0x25,   0x1F); //Call the function (Instruction 0x1C)
	...
	cpu.setMemory8 (0x29,   0x1E); //Pop top of stack and store (Instruction 0x1E)
	...
	cpu.setMemory8 (0x2F,   0x20); //Return (Instruction 0x20)
	cpu.setMemory16(0x30, 0xFFF3); //Set argument 1: register 3 (register in 0xFFF0.0xFFF7 format)
	cpu.setMemory8 (0x32,   0x20); //Return (Instruction 0x20)
